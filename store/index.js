...
export const actions = {
  ...
  getInActiveComponents({ commit, state }) {
    return new Promise((resolve, reject) => {
      axios({
        method: "GET",
        url: state.api.getInactiveComponents + 1,
        contentType: "application/json",
        headers: {
          Authorization: "Token " + localStorage.getItem("token")
        }
  ...
  updateInActiveComponents({ commit, state }, payload) {
    return new Promise((resolve, reject) => {
      axios({
        method: "PUT",
        data: payload,
  ...
  updateActiveComponents({ commit, state }, payload) {
    return new Promise((resolve, reject) => {
      axios({
        method: "PUT",
        data: payload,
